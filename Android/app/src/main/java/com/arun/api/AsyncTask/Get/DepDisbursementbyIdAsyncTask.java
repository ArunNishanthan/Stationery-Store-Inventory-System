...
public class DepDisbursementbyIdAsyncTask extends AsyncTask<String, Void,JSONObject> {
    public ICallback callback;

    public DepDisbursementbyIdAsyncTask(ICallback callback)
    {
        this.callback= callback;
    }

    public DepDisbursementbyIdAsyncTask() {
    ...
    protected JSONObject doInBackground(String... strings) {
        ...
        try {
            URL url = new URL("http://10.0.2.2:1256/api/Item/DeptDisburmentListsbyId?empId="+id);
